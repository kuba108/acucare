...
export const SYMPTOM_OPTIONS: SymptomOption[] = [
  {
    ...
    pointIds: ['ub-22', 'ub-25', 'ub-32', 'ub-40', 'ub-60']
  },
  {
    ...
    pointIds: ['li-4', 'gb-20', 'gb-12', 'gb-14', 'ub-2']
  },
  {
    id: 'nespavost-spanek',
    ...
    pointIds: ['ht-7', 'sp-6', 'pc-6', 'kd-3', 'gv-20']
  },
  {
    id: 'stres-uzkost',
  ...
  },
  {
    ...
    pointIds: ['li-20', 'lu-7', 'lu-11', 'ub-12', 'ub-13']
  },
  {
    id: 'traveni-zaludek',
    ...
    iconName: 'Flame',
    keywords: ['traveni', 'nadymani', 'zaludek', 'zlucnik', 'zacpa', 'krece', 'bricho', 'prujem', 'zlucnik', 'paleni zahy'],
    pointIds: ['st-36', 'st-25', 'cv-12', 'sp-9']
  },
  {
  ...
  },
  {
    ...
    pointIds: ['li-10', 'li-11', 'gb-30', 'sp-8', 'si-11']
  },
  {
    ...
    iconName: 'Sparkles',
    keywords: ['nevolnost', 'vraceni', 'zaludku', 'tehotenska nevolnost', 'zvraceni', 'zaludek'],
    pointIds: ['pc-6', 'st-36']
  },
  {
    id: 'sluch-usi-sumeni',
  ...
  },
  {
    ...
    pointIds: ['li-4', 'li-10', 'li-11', 'lu-7', 'lu-9', 'pc-6', 'sj-5']
  },
  {
    ...
    pointIds: ['st-36', 'sp-6', 'sp-9', 'kd-3', 'lv-3', 'ub-40', 'ub-60']
  }
];
